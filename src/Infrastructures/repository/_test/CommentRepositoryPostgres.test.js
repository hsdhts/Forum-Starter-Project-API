...
describe("CommentRepositoryPostgres", () => {
  ...
  describe("addComment function", () => {
    ...
    it("should return added comment correctly", async () => {
      ...
      // Action
      const addedComment = await commentRepositoryPostgres.masukkanComment(
        addComment
      );
  ...
  describe("getCommentById", () => {
    it("should return comment detail correctly", async () => {
      ...
      // Action
      const comment =
        await commentRepositoryPostgres.mendapatkanCommentBerdasarkanId(
          "comment-123"
        );
    ...
    it("should throw error when comment not found", async () => {
      ...
      // Action
      const action =
        commentRepositoryPostgres.mendapatkanCommentBerdasarkanId(
          "comment-123"
        );
  ...
  describe("hapusComment", () => {
    it("should throw InvariantError when comment id is not provided", async () => {
      ...
      // Action and Assert
      await expect(
        commentRepositoryPostgres.hapusComment()
    ...
    it("should throw InvariantError when comment id is not valid", async () => {
      ...
      // Action and Assert
      await expect(
        commentRepositoryPostgres.hapusComment("invalid-id")
      ).rejects.toThrowError(InvariantError);
    });
  ...
  describe("getCommentsByThreadId", () => {
    it("should return empty array when thread id is not provided", async () => {
      ...
      // Action
      const comments =
        await commentRepositoryPostgres.mendapatkanCommentsBerdasarkanThreadId();
